(module
 ...
 (memory $0 1)
 (data (i32.const 1036) ",")
 (data (i32.const 1048) "\01\00\00\00\10\00\00\00A\00s\00B\00i\00n\00d\00:\00 ")
 (data (i32.const 1084) "\1c")
 (data (i32.const 1096) "\01")
 (data (i32.const 1116) "<")
 ...
 (export "myExportedFunctionThatTakesAString" (func $export:assembly/index/myExportedFunctionThatTakesAString))
 (start $~start)
 ...
 (func $export:assembly/index/myExportedFunctionThatTakesAString (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 ;; custom section "as-bind_bindings", size 210, contents: "{\"typeIds\":{\"~lib/string/String\":{\"id\":1,\"byteSize\":0}},\"importedFunctions\":{},\"exportedFunctions\":{\"myExportedFunctionThatTakesAString\":{\"returnType\":\"~lib/string/String\",\"parameters\":[\"~lib/string/String\"]}}}"
)
